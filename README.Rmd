...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/threadingdata/tester/branch/main/graph/badge.svg)](https://codecov.io/gh/threadingdata/tester?branch=main)
...
The goal of tester is to establish a coherent workflow for building R-packages.  The package itself is best used as a doormat to the home that the R-community built.
